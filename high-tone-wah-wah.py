...
audio = audiobusio.I2SOut(bit_clock=board.GP10, word_select=board.GP9, data=board.GP11)
...
print("🌊 High Swell Blob (High Tone + Light) running!")
        ...
        if cm > max_cm:
            ...
            if not is_playing:
                ...
                for i in range(num_oscillators):
                    ...
                    f = freq * detune
                    note = synthio.Note(frequency=f, amplitude=amp, waveform=waveform, envelope=amp_env)
                    synth.press(note)
